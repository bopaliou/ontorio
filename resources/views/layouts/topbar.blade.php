<header class="h-16 bg-white/80 backdrop-blur-md border-b border-gray-100 flex items-center justify-between px-4 sm:px-6 lg:px-8 z-20 sticky top-0 transition-all duration-300">
    ...
    <div class="flex items-center gap-4">
        ...
        <!-- Notifications -->
        <a href="{{ route('dashboard.refresh-cache') }}" class="p-2 text-gray-400 hover:text-[#cb2d2d] hover:bg-red-50 rounded-xl transition-all duration-300" title="Rafraîchir les données (Vider le cache)">
