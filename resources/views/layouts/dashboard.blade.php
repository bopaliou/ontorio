...
<body class="bg-slate-50 text-slate-900 sidebar-open">
    ...
    <script>
        ...
        // �tat initial : ouvert sur desktop, ferm� sur mobile
    ...
    <script>
        // Navigation sans rechargement complet (PJAX l�ger)
        ...
        async function loadPartial(url, push = true) {
            try {
                ...
                // Mettre � jour les classes "active" de la sidebar
                if (newSidebar) {
                ...
                console.error('Navigation AJAX �chou�e, rechargement classique', e);
