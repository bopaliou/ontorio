                    ...
                    <form action="{{ route('proprietaires.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="adresse"
                                      id="adresse"
                                      rows="3"
                                      class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('adresse') border-red-500 @enderror">{{ old('adresse') }}</textarea>
                            @error('adresse')
                                <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                            @enderror
                        </div>
