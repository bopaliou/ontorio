                    ...
                    <form id="bien-main-form" class="p-6 space-y-4" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="col-span-1 md:col-span-2 relative">
                                <label class="block text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-2 ml-1">Nom du Bien</label>
                            ...
                            <!-- Type -->
                            <div class="relative">
                                <label class="block text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-2 ml-1">Type de Bien</label>
                            ...
                            <!-- Loyer -->
                            <div class="relative">
                                <label class="block text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-2 ml-1">Loyer Mensuel</label>
                                <div class="relative group">
                            ...
                            <!-- Adresse -->
                            <div class="col-span-1 md:col-span-2 relative">
                                <label class="block text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-2 ml-1">Adresse Complète</label>
                            ...
                            <!-- Nombre de pièces -->
                            <div class="relative">
                                <label class="block text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-2 ml-1">Pièces</label>
                            ...
                            <div class="relative flex items-center justify-between bg-gray-50 rounded-2xl px-5 py-4">
                                <label class="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Bien Meublé ?</label>
