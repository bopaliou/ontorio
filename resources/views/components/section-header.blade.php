{{-- 
    ...
    Usage: @include('components.section-header', [
        ...
        'icon' => 'building', // optionnel
        'actions' => '<button>...</button>' // optionnel
    ])
--}}

@props(['title', 'subtitle' => '', 'icon' => null, 'actions' => null])
...
<div class="flex flex-col sm:flex-row sm:items-end justify-between border-b border-gray-100 pb-6 mb-8 gap-4">
    <div class="flex items-start gap-4">
        ...
        @endif
        <div>
            <h2 class="text-2xl font-bold text-[#274256] tracking-tight">{{ $title }}</h2>
            @if($subtitle)
