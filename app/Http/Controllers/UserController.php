...
{
    private const GENERIC_ERROR_MESSAGE = 'Une erreur est survenue. Veuillez réessayer.';
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return response()->json(['success' => false, 'message' => self::GENERIC_ERROR_MESSAGE], 500);
        }
    }
